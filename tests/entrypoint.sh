...
case "$1" in
    "directory-watcher")
        ...
        ;;
    "configdb-watcher")
        CMD="SDP_CONFIG_HOST='etcd' dlm-configdb-watcher --source-storage sdp-watcher -r /dlm/testing1 --migration-destination-storage-name dlm-archive -m http://dlm_migration:8004"
        ;;
    *)
