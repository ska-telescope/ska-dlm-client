...
class GatewayApi:
    ...
    def login_login_get(
        ...
        _param = self._login_login_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def login_login_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def login_login_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _login_login_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def token_token_get(
        ...
        _param = self._token_token_get_serialize(
            username=username,
            password=password,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def token_token_get_with_http_info(
        self,
        username: StrictStr,
        password: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def token_token_get_without_preload_content(
        self,
        username: StrictStr,
        password: StrictStr,
        _request_timeout: Union[
    ...
    def _token_token_get_serialize(
        self,
        username,
        password,
        _request_auth,
