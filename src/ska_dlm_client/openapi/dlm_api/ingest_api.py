...
class IngestApi:
    ...
    def register_data_item(
        ...
        item_size: Annotated[
            Optional[StrictInt], Field(description="size of the data item in bytes.")
        ] = None,
        decompressed_size: Annotated[
            Optional[StrictInt],
            Field(description="size of the data item in bytes after decompression."),
        ] = None,
    ...
    def _register_data_item_serialize(
        ...
        if item_size is not None:
            ...
            _query_params.append(("item_size", item_size))

        if decompressed_size is not None:

            _query_params.append(("decompressed_size", decompressed_size))
