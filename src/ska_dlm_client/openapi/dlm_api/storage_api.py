...
class StorageApi:
    ...
    def check_storage_access(
        ...
        storage_name: Annotated[
            Optional[StrictStr],
            Field(description="The name of the storage volume (either name or ID are required)"),
        ] = None,
        storage_id: Annotated[
            Optional[StrictStr], Field(description="The ID of the storage volume.")
        ] = None,
        remote_file_path: Annotated[Optional[StrictStr], Field(description="Remote file.")] = None,
        ...
        ----------
        storage_name : str
            The name of the storage volume (either name or ID are
            required)
        storage_id : str
        ...
        _param = self._check_storage_access_serialize(
    ...
    @validate_call
    def check_storage_access_with_http_info(
        self,
        storage_name: Annotated[
            Optional[StrictStr],
            Field(description="The name of the storage volume (either name or ID are required)"),
    ...
    @validate_call
    def check_storage_access_without_preload_content(
        self,
        storage_name: Annotated[
            Optional[StrictStr],
            Field(description="The name of the storage volume (either name or ID are required)"),
    ...
    def _check_storage_access_serialize(
        self,
        storage_name,
        storage_id,
        remote_file_path,
        ...
        if remote_file_path is not None:
            ...
            _query_params.append(("remote_file_path", remote_file_path))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/storage/check_storage_access",
    ...
    def create_rclone_config(
        ...
        Parameters
        ----------
        request_body : Dict[str, Optional[object]]
            (required)
        _request_timeout : int, tuple(int, int), optional
            timeout setting for this request. If one number provided, it
            will be total request timeout. It can also be a pair (tuple)
    ...
    def rclone_about(
        self,
        volume: Annotated[StrictStr, Field(description="The configured rclone volume to query.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        ----------
        volume : str
            The configured rclone volume to query. (required)
        _request_timeout : int, tuple(int, int), optional
            timeout setting for this request. If one number provided, it
            will be total request timeout. It can also be a pair (tuple)
            of (connection, read) timeouts.
        ...
        _param = self._rclone_about_serialize(
            volume=volume,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def rclone_about_with_http_info(
        self,
        volume: Annotated[StrictStr, Field(description="The configured rclone volume to query.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def rclone_about_without_preload_content(
        self,
        volume: Annotated[StrictStr, Field(description="The configured rclone volume to query.")],
        _request_timeout: Union[
            None,
    ...
    def _rclone_about_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/storage/rclone_about",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rclone_access(
        ...
        remote_file_path: Annotated[
            Optional[StrictStr], Field(description='Remote file path, by default ""')
        ] = None,
        ...
        _param = self._rclone_access_serialize(
            volume=volume,
            remote_file_path=remote_file_path,
            timeout=timeout,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rclone_access_with_http_info(
        self,
        volume: Annotated[StrictStr, Field(description="Volume name")],
        remote_file_path: Annotated[
            Optional[StrictStr], Field(description='Remote file path, by default ""')
    ...
    @validate_call
    def rclone_access_without_preload_content(
        self,
        volume: Annotated[StrictStr, Field(description="Volume name")],
        remote_file_path: Annotated[
            Optional[StrictStr], Field(description='Remote file path, by default ""')
    ...
    def _rclone_access_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/storage/rclone_access",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
