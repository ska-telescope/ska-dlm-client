...
class StorageApi:
    ...
    def get_storage_config_storage_get_storage_config_get(
        ...
        :param storage_id: the storage id, by default \"\"
        :type storage_id: str
        :param storage_name: the name of the storage volume, by default \"\"
        :type storage_name: str
        :param config_type: query only the specified type, by default \"rclone\"
        :type config_type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
