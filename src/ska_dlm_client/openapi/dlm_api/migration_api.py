...
class MigrationApi:
    ...
    def get_migration_record(
        self,
        migration_id: Annotated[StrictInt, Field(description="Migration id of migration")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        ----------
        migration_id : int
            Migration id of migration (required)
        _request_timeout : int, tuple(int, int), optional
            timeout setting for this request. If one number provided, it
            will be total request timeout. It can also be a pair (tuple)
            of (connection, read) timeouts.
        ...
        _param = self._get_migration_record_serialize(
    ...
    @validate_call
    def get_migration_record_with_http_info(
        self,
        migration_id: Annotated[StrictInt, Field(description="Migration id of migration")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_migration_record_without_preload_content(
        self,
        migration_id: Annotated[StrictInt, Field(description="Migration id of migration")],
        _request_timeout: Union[
            None,
    ...
    def _get_migration_record_serialize(
        self,
        migration_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/migration/get_migration",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
