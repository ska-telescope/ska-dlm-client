...
def contenttype_matches(contenttype, maintype, subtype):
    ...
    -------
    bool
        `true` when the given content type matches the given type and
        subtype, regardless of the presence of mime type parameters,
...
class RESTClientObject:
    ...
    def request(
        ...
        post_params
            request post parameters, `application/x-www-form-urlencoded`
