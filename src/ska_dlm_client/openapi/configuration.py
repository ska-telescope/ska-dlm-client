...
class Configuration:
    ...
    server_operation_variables
        ...
        values before.
    verify_ssl
        bool - Set this to false to skip verifying SSL certificate when
        calling API from https server.
    ssl_ca_cert
    ...
    connection_pool_maxsize
        Connection pool max size. None in the constructor is coerced to
        100 for async and cpu_count * 5 for sync.
    proxy
        Proxy URL.
    no_proxy
    ...
    proxy_headers
        Proxy headers.
    proxy_ssl_context
        SSL context used only for the TLS handshake with the proxy
        itself, independent of the destination TLS settings.
