#
from openapi_client_dlm import configuration, api_client
from openapi_client_dlm.dlm_api import request_api, storage_api

gateway_configuration = configuration.Configuration(host='http://localhost:8000')
ingest_configuratio = configuration.Configuration(host='http://localhost:8001')
request_configuratio = configuration.Configuration(host='http://localhost:8002')
storage_configuration = configuration.Configuration(host='http://localhost:8003')
migration_configuratio = configuration.Configuration(host='http://localhost:8004')
