...
# **register_data_item**
> str register_data_item(item_name, uri, item_type=item_type, target_phase=target_phase, uid_expiration=uid_expiration, oid_expiration=oid_expiration, storage_name=storage_name, storage_id=storage_id, parents=parents, item_size=item_size, decompressed_size=decompressed_size, do_storage_access_check=do_storage_access_check, authorization=authorization, request_body=request_body)
...
with ska_dlm_client.openapi.ApiClient(configuration) as api_client:
    ...
    item_size = 56 # int | size of the data item in bytes. (optional)
    decompressed_size = 56 # int | size of the data item in bytes after decompression. (optional)
    ...
    try:
        # Register Data Item
        api_response = api_instance.register_data_item(item_name, uri, item_type=item_type, target_phase=target_phase, uid_expiration=uid_expiration, oid_expiration=oid_expiration, storage_name=storage_name, storage_id=storage_id, parents=parents, item_size=item_size, decompressed_size=decompressed_size, do_storage_access_check=do_storage_access_check, authorization=authorization, request_body=request_body)
 ...
 **item_size** | **int**| size of the data item in bytes. | [optional] 
 **decompressed_size** | **int**| size of the data item in bytes after decompression. | [optional] 
