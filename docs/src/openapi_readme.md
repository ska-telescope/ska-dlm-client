...
*StorageApi* | [**check_storage_access**](openapi_dlm_client/StorageApi.md#check_storage_access) | **GET** /storage/check_storage_access | Check Storage Access
...
*StorageApi* | [**rclone_about**](openapi_dlm_client/StorageApi.md#rclone_about) | **GET** /storage/rclone_about | Rclone About
*StorageApi* | [**rclone_access**](openapi_dlm_client/StorageApi.md#rclone_access) | **GET** /storage/rclone_access | Rclone Access


## Models

 - [HTTPValidationError](openapi_dlm_client/HTTPValidationError.md)
 - [LocationInner](openapi_dlm_client/LocationInner.md)
