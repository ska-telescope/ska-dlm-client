...
> object init_data_item_ingest_init_data_item_post(item_name=item_name, phase=phase, body=body)
...
with openapi_client_dlm.ApiClient(configuration) as api_client:
    ...
    try:
        # Init Data Item
        api_response = api_instance.init_data_item_ingest_init_data_item_post(item_name=item_name, phase=phase, body=body)
...
> object register_data_item_ingest_register_data_item_post(item_name, uri=uri, storage_name=storage_name, storage_id=storage_id, item_format=item_format, eb_id=eb_id, body=body)
...
with openapi_client_dlm.ApiClient(configuration) as api_client:
    ...
    try:
        # Register Data Item
        api_response = api_instance.register_data_item_ingest_register_data_item_post(item_name, uri=uri, storage_name=storage_name, storage_id=storage_id, item_format=item_format, eb_id=eb_id, body=body)
